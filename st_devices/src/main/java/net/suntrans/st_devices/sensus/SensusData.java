 ...
 * Des:
 */
public class SensusData implements Parcelable {
...
//            }
    ...
    protected SensusData(Parcel in) {
    ...
    public static final Parcelable.Creator<SensusData> CREATOR = new Parcelable.Creator<SensusData>() {
        @Override
        public SensusData createFromParcel(Parcel source) {
            return new SensusData(source);
        }

        @Override
        public SensusData[] newArray(int size) {
            return new SensusData[size];
        }
    };
}
