 ...
 * Des:
 */
public class ScrollChild extends View implements NestedScrollingChild {
    private final static String TAG = "ScrollChild";
    ...
    public ScrollChild(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ScrollChild(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
