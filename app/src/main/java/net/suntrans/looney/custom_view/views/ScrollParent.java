 ...
 * Des:
 */
public class ScrollParent extends ViewGroup implements NestedScrollingParent {

    private static final String TAG = "ScrollParent";

    private NestedScrollingParentHelper mScrollingParentHelper = new NestedScrollingParentHelper(this);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mChildView.layout(childLeft,childTop,mChildView.getMeasuredWidth(),mChildView.getMeasuredHeight());
    }
    ...
    public void onNestedScrollAccepted(View child, View target, int nestedScrollAxes) {
        Log.d(TAG,"onNestedScrollAccepted=>"+target.getClass().getSimpleName());
