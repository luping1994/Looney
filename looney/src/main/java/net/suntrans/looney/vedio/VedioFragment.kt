...
import net.suntrans.looney.databinding.FragmentVedioBinding
import net.suntrans.looney.vedio.base.HiTools
import net.suntrans.looney.vedio.camhi.*
import java.io.File
...
abstract class VedioFragment : BasedFragment(), ICameraIOSessionCallback {
...
//        println("item高度为$itemHeight,屏幕宽度为${metric.widthPixels}")
    ...
    private inner class VH(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            name = itemView!!.findViewById(R.id.name1) as TextView?
            image = itemView!!.findViewById(R.id.snapshot) as ImageView?
            stateTx = itemView!!.findViewById(R.id.state) as TextView?
